...
class FlFrame (wx.StaticBox):
	def __init__(self, parent, pname, settings):
		...
		st = wx.StaticText(self, wx.ID_ANY, "Object Height: ", size=(120, -1), style=wx.ALIGN_RIGHT)
		st.SetFont(self.ftb)
		hsz2.Add(st)
		...
		hsz2 = wx.BoxSizer(wx.HORIZONTAL)
		hsz2.AddSpacer(self.hspacing)
		st = wx.StaticText(self, wx.ID_ANY, "Print Estimate: ", size=(120, -1), style=wx.ALIGN_RIGHT)
		st.SetFont(self.ftb)
		hsz2.Add(st)
		...
		hsz2 = wx.BoxSizer(wx.HORIZONTAL)
		hsz2.AddSpacer(self.hspacing)
		st = wx.StaticText(self, wx.ID_ANY, "Layer Height: ", size=(120, -1), style=wx.ALIGN_RIGHT)
		st.SetFont(self.ftb)
		hsz2.Add(st)
		...
		hsz2 = wx.BoxSizer(wx.HORIZONTAL)
		hsz2.AddSpacer(self.hspacing)
		st = wx.StaticText(self, wx.ID_ANY, "Total Filament: ", size=(120, -1), style=wx.ALIGN_RIGHT)
		st.SetFont(self.ftb)
		hsz2.Add(st)
