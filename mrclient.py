...
class SocketClient(object):
    ...
    def _ws_on_close(self, ws, status, msg):
        """
...
class Client(object):
    ...
    def prepare_request(self, method=None, path=None, params=None):
        ...
        return requests.Request(method=method, url=url, params=params).prepare()
    ...
    def create_socket(self, **kwargs):
        url = "ws://{}/websocket".format(self.baseurl[self.baseurl.find("//") + 2:])
